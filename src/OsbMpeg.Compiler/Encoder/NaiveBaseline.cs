...
/// <summary>
///     Estimates the "just dump every frame as its own full-canvas sprite" strawman —
...
public static class NaiveBaseline
{
    ...
    public static async Task<NaiveBaselineStats> EstimateAsync(
        string inputPath, int width, int height, TimeSpan? start, TimeSpan? duration, int realFrameCount,
