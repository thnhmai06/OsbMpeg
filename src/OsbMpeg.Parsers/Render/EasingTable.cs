...
/// <summary>
///     Standard Penner easing equations, indexed to match osu-framework's Easing enum
///     order (0..34; see Ir/SbEasing.cs). t is normalized progress in [0,1].
/// </summary>
public static class EasingTable
{
    private const double Pi = Math.PI;

    public static double Apply(SbEasing easing, double t)
    {
        return easing switch
        {
            ...
            SbEasing.OutExpo => t.IsEqual(1) ? 1 : 1 - Math.Pow(2, -10 * t),
    ...
    private static double OutQuad(double t)
    {
        return 1 - (1 - t) * (1 - t);
    }
    ...
    {
        return OutElasticAmplitude(t, 1);
    }
